...
// Zone configurations for word generation
const ZONE_CONFIG = {
...
[
  ...
  try {
    ...
    // Fallback words if JSON parse fails
...
Look carefully at the photo. Does it show a "${word}"?
...
// Fallback words per zone in case API fails
const getFallbackWords = (zone) => {
  const fallbacks = {
    ...
    4: [
      { word: 'crate', definition: 'A wooden or plastic box used to store or transport goods', bangla_hint: 'বাক্স', emoji: '📦', where_to_find: 'At the market stalls', difficulty: 3 },
      { word: 'scales', definition: 'A device used to weigh things', bangla_hint: 'দাঁড়িপাল্লা', emoji: '⚖️', where_to_find: 'At the market weighing counter', difficulty: 3 },
      ...
      { word: 'burlap', definition: 'A rough fabric used to make sacks', bangla_hint: 'চট', emoji: '🎒', where_to_find: 'Sacks at the market', difficulty: 4 }
    ],
    5: [
      { word: 'embankment', definition: 'A raised bank of earth or stone built to hold back water', bangla_hint: 'বাঁধ', emoji: '🌊', where_to_find: 'Near rivers or canals', difficulty: 4 },
      { word: 'congregation', definition: 'A group of people gathered for religious worship', bangla_hint: 'সমাবেশ', emoji: '🕌', where_to_find: 'At the mosque or temple', difficulty: 5 },
      { word: 'reservoir', definition: 'A large natural or artificial lake used as a water supply', bangla_hint: 'জলাধার', emoji: '💧', where_to_find: 'Near water treatment areas', difficulty: 5 },
      { word: 'monument', definition: 'A statue or structure built to remember a person or event', bangla_hint: 'স্মৃতিস্তম্ভ', emoji: '🗿', where_to_find: 'In parks or public squares', difficulty: 5 },
    ...
    6: [
      { word: 'shoreline', definition: 'The edge of land where it meets the sea or a lake', bangla_hint: 'তীরভূমি', emoji: '🏖️', where_to_find: 'At the beach or riverbank', difficulty: 6 },
      { word: 'tributary', definition: 'A river or stream that flows into a larger river', bangla_hint: 'উপনদী', emoji: '🌊', where_to_find: 'Where small rivers meet bigger ones', difficulty: 6 },
      { word: 'heritage', definition: 'Traditions, buildings, and art that are part of history', bangla_hint: 'ঐতিহ্য', emoji: '🏛️', where_to_find: 'At historical sites or museums', difficulty: 6 },
      ...
      { word: 'industrial', definition: 'Related to factories and large-scale production', bangla_hint: 'শিল্প', emoji: '🏭', where_to_find: 'In factory or industrial zones', difficulty: 6 }
    ]
  }
